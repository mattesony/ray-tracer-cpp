Build the program with Qt5's "qmake" ("/usr/lib/x86_64-linux-gnu/qt5/bin/qmake") and "make", then run with "./RayTracer" (or just open the .pro project file in Qt Creator with Qt 5.9.2 and run there).
